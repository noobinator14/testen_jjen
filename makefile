mygod : test_main.o buffer.o index.o bydir_SCC.o SimpleL_pointer.o hash.o scc.o connected_comp.o mybfs.o bydir.o grail.o bidir_grail.o
	gcc -o path test_main.o buffer.o index.o bydir_SCC.o SimpleL_pointer.o hash.o scc.o connected_comp.o mybfs.o bydir.o grail.o bidir_grail.o
